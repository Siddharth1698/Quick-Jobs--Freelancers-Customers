                    ...
                    for (DataSnapshot child:dataSnapshot.getChildren()){
                        ...
                        if (child.getKey().equals("driver")){
                            ...
                            if(!driverId.equals(currentUserId)){
                                ...
                                getUserInformation("Freelancers", driverId);
    ...
    private void displayCustomerRelatedObjects() {
        ...
        mRatingBar.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            ...
            public void onRatingChanged(RatingBar ratingBar, float rating, boolean fromUser) {
                ...
                DatabaseReference mDriverRatingDb = FirebaseDatabase.getInstance().getReference().child("Users").child("Freelancers").child(driverId).child("rating");
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    ...
                    if(map.get("profileImageUrl") != null){
                        Picasso.get().load(map.get("profileImageUrl").toString()).into(userImage);
                    }
                }
