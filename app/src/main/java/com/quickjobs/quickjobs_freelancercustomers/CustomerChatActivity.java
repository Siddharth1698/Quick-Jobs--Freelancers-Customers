...
private  String freelancerFoundId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        groupNameRef = FirebaseDatabase.getInstance().getReference().child("Chats").child(freelancerFoundId);
    ...
    private void saveMessageInfoToDatabase() {
        ...
        if (TextUtils.isEmpty(message)){
            Toast.makeText(CustomerChatActivity.this,"Empty feild",Toast.LENGTH_SHORT);
        }else{
